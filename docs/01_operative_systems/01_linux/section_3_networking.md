...
Este capítulo cubre la automatización de tareas mediante alias y scripts de
configuración, junto con las herramientas básicas de gestión de red y diagnóstico de
puertos.
