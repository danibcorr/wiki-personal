...
Este capítulo aborda las prácticas de integración y despliegue continuos, con
implementaciones prácticas en GitHub Actions y GitLab CI/CD.
...
???+ example "Configuración de Python, Poetry y Flake8"
...
???+ example "Uso de caché para optimización de workflows"
...
???+ example "Estructura básica de un _pipeline_"
...
???+ example "Inclusión de ficheros locales y remotos"
