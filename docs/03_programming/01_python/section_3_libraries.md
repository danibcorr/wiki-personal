...
description: Librerías complementarias del ecosistema Python.
title: Librerías
---
...
| ----------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------- |
| **PyPDF**         | Permite manipular archivos PDF, incluyendo lectura, escritura, combinación y extracción de contenido.                                         | pdf, documentos, extracción, lectura, escritura    |
