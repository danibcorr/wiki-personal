...
???+ example "Juego de adivinar"
    ...
    El siguiente programa integra varios conceptos: entrada/salida estándar, constantes,
    bucles, _pattern matching_ con `match` y gestión de dependencias externas.
    ...
    !!! note "Dependencia externa"
        ...
        Este ejemplo requiere añadir el *crate* `rand` en `Cargo.toml`:
